...
public class SmartService {
    ...
    //*************************************************************
    // Classe Singleton para gerenciamento de conexões
    //*************************************************************
    ...
    //*****************************************************************************
    // Funções para processamento dos dados lidos de cada estação da bancada Smart
    //*****************************************************************************
    //********************************************************************************************************************************************** */
        ...
        if ((posicaoEstoque > 0) && removerEstoque == true) {
            if (!readOnly) {
                ...
                try {
                    ...
                    String estoqueApiUrl = apiUrlConfig.getEstoqueApiUrl();

                    // Envia a requisição
                    ResponseEntity<String> response = restTemplate.postForEntity(estoqueApiUrl + "/salvar", request, String.class);
